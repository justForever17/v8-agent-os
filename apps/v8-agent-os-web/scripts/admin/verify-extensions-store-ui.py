...
async def main():
    ...
    parser.add_argument("--url", default="http://127.0.0.1:9527")
    ...
    async with async_playwright() as p:
        ...
        async def route_api(route):
            ...
            data = {}
            if url.path == "/api/admin/extensions/store/operations":
            ...
            elif url.path == "/api/admin/ui-preferences/theme":
                if route.request.method == "PUT":
                    theme_state.update(route.request.post_data_json)
                data = theme_state
            elif url.path == "/api/admin/client/instance":
                data = {"instanceId": "isolated-ui-fixture", "name": "Fixture"}
            elif url.path == "/api/admin/models":
                data = []
            elif url.path == "/api/admin/extensions/health":
                await route.fulfill(status=503, json={"detail": "Synthetic health unavailable"})
                return
            elif url.path == "/api/admin/extensions/catalog":
            ...
            elif url.path == "/api/admin/mcp/config":
            ...
            elif url.path == "/api/admin/config-registry/extensions":
