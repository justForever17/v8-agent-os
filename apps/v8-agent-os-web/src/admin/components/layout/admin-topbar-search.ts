import { ADMIN_NAV_GROUPS, type AdminNavItem } from "@admin/lib/admin-navigation";
import { getTranslationVariants } from "@admin/lib/locale";
import { RUNTIME_CONTROL_HREF } from "@admin/lib/runtime-admin";
import { ir } from "@admin/i18n/admin-legacy";
