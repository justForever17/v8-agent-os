...
def render_memory_extraction_prompt(format_instructions: str) -> str:
    return (
        ...
        "4. Do NOT store temporary transport constraints, temporary voice/media workaround details, experimental tags, or one-off channel reply formatting rules as durable knowledge.\n"
