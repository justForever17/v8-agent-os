...
export const HTMLFileCard = memo(function HTMLFileCard({
    ...
    const handleDownload = async () => {
        try {
            ...
            Alert.alert(t("src.components.chat.downloadfilecard.download_failed"), error instanceof Error ? error.message : t("src.components.chat.htmlfilecard.unable_to_save_html_file"));
        }
    };
