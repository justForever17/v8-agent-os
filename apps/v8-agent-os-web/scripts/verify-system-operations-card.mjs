...
export async function verifySystemOperationsCard(page, baseUrl) {
    ...
    await page.route("**/api/admin/config-registry/system-base*", (route) => {
    ...
    await page.route("**/api/admin/system-operations/**", async (route) => {
    ...
    await page.unroute("**/api/admin/system-operations/**");
    await page.unroute("**/api/admin/config-registry/system-base*");
}
