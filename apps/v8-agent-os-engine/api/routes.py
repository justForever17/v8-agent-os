...
from . import agent_browser_routes as agent_browser_routes_module
...
router.include_router(agent_browser_routes_module.router)
...
if service_enabled("creative_media", profile=_STARTUP_PROFILE):
    _include_optional_router("creative_media_routes")
    _include_optional_router("creative_canvas_routes")
...
router.include_router(system_operation_routes_module.router)
