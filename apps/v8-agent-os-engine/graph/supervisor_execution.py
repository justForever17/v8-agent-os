...
def build_supervisor_execution_authority_contract(
    *,
    ...
    return (
        ...
        "With a trusted Engineering Kernel, bounded self-contained file/command work may be implemented directly, including multiple dependent outputs. Choose an Engineering episode for requested or materially useful isolation, parallelism, recovery, or durable handoff. An active managed continuation keeps ownership until its typed handoff; local tools never override it.\n"
