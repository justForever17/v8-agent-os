...
export const PPTCard = memo(function PPTCard({
    ...
    const handleDownload = async () => {
        try {
            ...
            Alert.alert(t("src.components.chat.downloadfilecard.download_failed"), error instanceof Error ? error.message : t("src.components.chat.pptcard.unable_to_save_ppt_file"));
        }
    };
