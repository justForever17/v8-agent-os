...
export const RUNTIME_EVENT_TAXONOMY: RuntimeEventTaxonomyEntry[] = [
  ...
  { key: "engineering.trigger", topicPattern: "engineering_lane.", runtimeId: "engineering_lane", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "hud"], explicit: true },
  { key: "engineering.lifecycle", topicPattern: "engineering.", runtimeId: "engineering_lane", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "hud"], explicit: true },
