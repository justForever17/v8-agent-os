...
export function RpaPanelContent({ embedded = false }: { embedded?: boolean } = {}) {
    ...
    if (status !== "authenticated" || loading) return <LoadingScreen label={t("src.screens.rpascreen.loading")} />;
