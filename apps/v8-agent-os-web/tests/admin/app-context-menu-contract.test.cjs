...
test("admin mounts the semantic desktop context menu", () => {
  ...
  const menu = read("src/admin/components/ui/AppContextMenu.tsx");
  ...
  assert.match(read("src/admin/components/admin-shell/SettingToggleCard.tsx"), /data-v8-context-menu-ignore/);
