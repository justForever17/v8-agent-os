# Nuwa Einstein Supervisor SYSTEM_CONTENT Dry Run - 2026-04-21_22-01-16

## 导出口径
- 模拟用户发言：`使用女娲技能调研爱因斯坦生成一个爱因斯坦skill`
- 只跑真实 `build_supervisor_route(...)` + `build_supervisor_system_content(...)`。
- 未调用模型，未执行工具，未手动注入女娲。
- Session: `dry-run-nuwa-einstein-2026-04-21_22-01-16`

## 与上一轮对比 / 意外发现
```json
{
  "currentFindings": {
    "huashuNuwaSelected": true,
    "huashuNuwaStage1": true,
    "legacyInSubagentSystem": [],
    "legacyInSubagentTools": [
...
## Filtered Supervisor Tools
```json
[
  {
    "description": "Fetches the detailed markdown workflow instructions for a specific given skill name.",
    "name": "fetch_skill_instructions"
  },
  {
    "description": "Unified delegation broker for local subagents and external workers: dispatch, observe, resume, or interrupt delegated work.",
    "name": "delegation_broker"
  },
  {
    "description": "Run a system command through a unified command surface.",
    "name": "run_system_command"
  },
  {
    "description": "Unified command-session broker for long-running or interactive CLI work: start, observe, input, or terminate a session with compact JSON by default.",
    "name": "command_session_broker"
  },
  {
    "description": "List locally available .robot scripts managed by the active RPA script store.",
    "name": "rpa_list_robot_scripts"
  },
  {
    "description": "Run an existing RPA draft script through RPARuntime.",
    "name": "rpa_run_draft"
  },
  {
    "description": "Run an existing .robot flow through RPARuntime without requiring trace compilation.",
    "name": "rpa_run_existing_flow"
  },
  {
    "description": "List desktop applications in a Supervisor-friendly way.",
    "name": "computer_use_list_apps"
  },
  {
    "description": "Return the current desktop driver/runtime capability summary in a compact format.",
    "name": "computer_use_desktop_capabilities"
  },
  {
    "description": "Resolve whether the desktop task should reuse muscle memory, run hybrid, or enter learning mode.",
    "name": "computer_use_resolve_execution_route"
  },
  {
    "description": "Execute a route-approved desktop task through the unified task-level broker and return a compact verification summary.",
    "name": "computer_use_execute_task"
  },
  {
    "description": "Observe the current desktop scene in a compact, Supervisor-friendly format.",
    "name": "computer_use_observe_scene"
  },
  {
    "description": "Read contents of a text file on the host filesystem.",
    "name": "read_native_file"
  },
  {
    "description": "Share a file from the current main/project workspace as a remote session resource for preview or download.",
    "name": "share_workspace_file"
  },
  {
    "description": "Write or append text content to a native file on the host filesystem.",
    "name": "write_native_file"
  },
  {
    "description": "Search for a specific string pattern within a file or directory recursively.",
    "name": "grep_search"
  },
  {
    "description": "Resolve share pages and download remote media into the current workspace.",
    "name": "download_media_for_vision"
  },
  {
    "description": "Unified web broker for public-web work: search finds results, fetch auto-routes URL vs query, read returns cleaned page text, and extract returns structured article/links/metadata/media output; add debug=true only for transport diagnostics.",
    "name": "web_broker"
  },
  {
    "description": "Explicitly delegate a task to a trusted remote V8 node and wait for the final result.",
    "name": "delegate_network_task"
  },
  {
  ...
  {
    "description": "Unified S3 broker for upload, list, and download operations with a compact JSON contract.",
    "name": "s3_broker"
  },
  {
    "description": "Pause briefly for a bounded number of seconds, then continue with an optional reminder note.",
    "name": "wait"
  },
  {
    "description": "Unified hybrid memory retrieval tool. Call this to search the memory system for facts, code snippets, or user preferences.",
    "name": "memory_recall"
  },
  {
    "description": "Update or delete an existing knowledge item by ID.",
    "name": "mem_update"
  },
  {
    "description": "Expand a brokered memory map node and return its children.",
    "name": "memory_map_expand"
  },
  {
    "description": "Read a single memory day log by brokered memoryRef or YYYY-MM-DD date.",
    "name": "memory_read_day"
  },
  {
    "description": "Ask the user for mandatory input or confirmation and pause the graph until a response is provided.",
    "name": "ask_user"
  },
  {
    "description": "Create a structured task plan ONLY after user requirements are fully clarified.",
    "name": "write_todos"
  },
  {
    "description": "Mark a todo item's status to track progress.",
    "name": "update_todo"
  },
  {
    "description": "Analyze images and videos directly using a powerful Vision LLM.",
    "name": "vision_media_analyzer"
  },
  {
    "description": "从 OpenClaw 运行日志推断的动态工具：feishu_app_scopes",
    "name": "openclaw-lark.feishu_app_scopes"
  },
  {
    "description": "从 OpenClaw 运行日志推断的动态工具：feishu_bitable",
    "name": "openclaw-lark.feishu_bitable"
  },
  {
    "description": "从 OpenClaw 运行日志推断的动态工具：feishu_chat",
    "name": "openclaw-lark.feishu_chat"
  },
  {
    "description": "从 OpenClaw 运行日志推断的动态工具：feishu_doc",
    "name": "openclaw-lark.feishu_doc"
  },
  {
    "description": "从 OpenClaw 运行日志推断的动态工具：feishu_drive",
    "name": "openclaw-lark.feishu_drive"
  },
  {
    "description": "从 OpenClaw 运行日志推断的动态工具：feishu_wiki",
    "name": "openclaw-lark.feishu_wiki"
  }
]
```

## Extensions Runtime Block
```text
...
## Supervisor Direct Tool Registry Block
```text
...
## Specialist Agent Registry Block
```text
