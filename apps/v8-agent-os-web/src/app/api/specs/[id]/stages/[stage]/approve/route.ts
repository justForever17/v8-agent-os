...
export async function POST(
    ...
    const result = await safeAdminProxyFetch(
        ...
        `/specs/${encodeURIComponent(id)}/stages/${encodeURIComponent(stage)}/approve`,
        {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body,
        },
        `/specs/${id}/stages/${stage}/approve`,
    );
    ...
    return relayJsonProxyResponse(result.response, "Failed to approve spec stage");
}
