...
const source = fs.readFileSync(path.join(__dirname, "../../src/admin/components/models/ModelCacheUsage.tsx"), "utf8");
...
function translate(locale) {
    const messages = JSON.parse(fs.readFileSync(path.join(__dirname, `../../src/admin/i18n/locales/${locale}.json`), "utf8"));
    return (key, params = {}) => {
