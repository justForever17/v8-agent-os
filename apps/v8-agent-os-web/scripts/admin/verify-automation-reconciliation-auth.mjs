...
const get = load("src/app/api/admin/automation/deliveries/route.ts").GET;
const post = load("src/app/api/admin/automation/deliveries/[deliveryId]/reconcile/route.ts").POST;
const req = {
    nextUrl: new URL("https://fixture.invalid/api/admin/automation/deliveries?limit=2&after=opaque&ownership=system,unresolved&user_id=system"),
