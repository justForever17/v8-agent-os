...
export const RUNTIME_EVENT_TAXONOMY: RuntimeEventTaxonomyEntry[] = [
  ...
  { key: "chat.ask_user_resolved", topicPattern: "ask_user.resolved", eventType: "custom_event", eventName: "approval_resolved", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["approval", "hud", "runtime_card"], explicit: true },
