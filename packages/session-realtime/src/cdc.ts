...
export function coerceAuthoritativeSessionSnapshot(raw: unknown): AuthoritativeSessionSnapshot | null {
  ...
  return {
    ...
    sessionCoordinationMessages: asRecordArray(
      root.sessionCoordinationMessages,
      root.session_coordination_messages,
      effectiveProjection.sessionCoordinationMessages,
      effectiveProjection.session_coordination_messages,
      nestedSnapshot.sessionCoordinationMessages,
      nestedSnapshot.session_coordination_messages,
    ) as AuthoritativeSessionSnapshot["sessionCoordinationMessages"],
    todos,
