...
class NetworkOpenAICompatConfig(BaseModel):
    ...
    allow_workspace_headers: bool = Field(default=False, alias="allowWorkspaceHeaders")
    allow_raw_workspace_path: bool = Field(default=False, alias="allowRawWorkspacePath")
    v8_main_chain_mode_enabled: bool = Field(default=False, alias="v8MainChainModeEnabled")
