...
export async function GET(
    ...
    try {
        const res = await engineFetch(`${ENGINE_URL}/projects/${id}`, {
            method: "GET",
        ...
        console.error("[ProjectAPI] GET failed:", error);
...
export async function PATCH(
    ...
    try {
        ...
        console.error("[ProjectAPI] PATCH failed:", error);
        return NextResponse.json({ error: "Backend Service Unavailable" }, { status: 502 });
    }
}
...
export async function DELETE(
    ...
    try {
        ...
        console.error("[ProjectAPI] DELETE failed:", error);
        return NextResponse.json({ error: "Backend Service Unavailable" }, { status: 502 });
    }
}
