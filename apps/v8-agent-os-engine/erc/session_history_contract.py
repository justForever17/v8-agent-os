...
def build_session_history_materialized_record(
    *,
    ...
    return {
        ...
        "pinnedAt": normalize_utc_iso(metadata.get("pinnedAt")),
        "workspaceDisplayName": _coerce_string(session_row.get("workspaceDisplayName")),
        "workspacePinned": bool(session_row.get("workspacePinned")),
        "workspacePinnedAt": normalize_utc_iso(session_row.get("workspacePinnedAt")),
        "projectName": _coerce_string(session_row.get("projectName")),
        "source": source,
