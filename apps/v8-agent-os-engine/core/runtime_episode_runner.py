    ...
    def _compact_cross_episode_result(
        ...
        *,
        ...
        return {
            ...
            "delegationId": source.get("delegationId") or source.get("delegation_id") or payload.get("delegationId") or payload.get("delegation_id"),
            "invocationId": source.get("invocationId") or source.get("invocation_id") or payload.get("invocationId") or payload.get("invocation_id"),
            "toolCallId": source.get("toolCallId") or source.get("tool_call_id") or payload.get("toolCallId") or payload.get("tool_call_id"),
