...
def test_runtime_taxonomy_keeps_planner_swarm_and_engineering_on_separate_lanes():
    ...
    assert 'key: "engineering.trigger", topicPattern: "engineering_lane.", runtimeId: "engineering_lane"' in taxonomy_source
    assert 'key: "engineering.lifecycle", topicPattern: "engineering.", runtimeId: "engineering_lane"' in taxonomy_source
