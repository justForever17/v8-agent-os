...
import { fetchConfigDomain, peekConfigDomain, saveConfigDomain, type ConfigRegistryEnvelope } from "@admin/lib/config-registry";
...
const SOURCE_PROVIDERS_URL = "/api/admin/research-runtime?view=source-providers";
