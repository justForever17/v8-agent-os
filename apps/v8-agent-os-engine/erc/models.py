...
class RuntimeSnapshotPayload:
    ...
    session_coordination_messages: List[Dict[str, Any]] = field(default_factory=list)
    ...
    def as_dict(self) -> Dict[str, Any]:
        return {
            ...
            "transcriptRevision": int((self.snapshot or {}).get("transcriptRevision") or 0),
            "contextEpoch": int((self.snapshot or {}).get("contextEpoch") or 0),
            "branch": (self.snapshot or {}).get("branch"),
            ...
            "sessionCoordinationMessages": list(self.session_coordination_messages),
            "lane": self.lane,
