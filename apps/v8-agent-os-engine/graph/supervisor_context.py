    ...
    *,
    ...
    def _plugin_authorization_context() -> str:
        ...
        lines = [
            ...
            "An available CLI reported by plugin_broker(status) runs through run_system_command without a plugin grant. Component IDs are grant identifiers, not Skill/MCP runtime names; authorize only the smallest Skill/MCP or delegated component set actually needed.",
