...
- Use `creative_media_reference_media_brief` for reference preflight, `creative_media_rank_models` for selector/ranking, `creative_media_production_pack` for stage state, `creative_media_sample_approval_packet` before calling `ask_user`, and `creative_media_qa_check` before final delivery.
