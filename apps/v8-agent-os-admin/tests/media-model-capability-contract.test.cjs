...
function modelHubSource() {
  return read("src/app/admin/(dashboard)/model-hub/page.tsx")
    + "\n" + read("src/lib/model-hub/catalog.ts")
    + "\n" + read("src/lib/model-hub/audio.ts")
    + "\n" + read("src/lib/model-hub/models.ts")
    + "\n" + read("src/lib/model-hub/editor-drafts.ts")
    + "\n" + read("src/components/model-hub/ModelEditorDialog.tsx")
    + "\n" + read("src/components/model-hub/ProviderEditorDialog.tsx")
