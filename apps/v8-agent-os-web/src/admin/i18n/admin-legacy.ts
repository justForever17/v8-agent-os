import zhCatalog from "@admin/i18n/locales/zh-CN.json";
import { INTERNAL_READABLE } from "@admin/i18n/internal-readable";
import type { TranslationKey, TranslationParams } from "@admin/lib/locale";
