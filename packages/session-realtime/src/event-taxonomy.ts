...
export const RUNTIME_EVENT_TAXONOMY: RuntimeEventTaxonomyEntry[] = [
  ...
  { key: "capability.need", topicPattern: "capability.need.", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_timeline"], explicit: true },
  { key: "runtime.episode.progress", topicPattern: "runtime.episode.progress", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_timeline"], explicit: true },
  { key: "runtime.episode", topicPattern: "runtime.episode.", runtimeId: "chat", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "hud"], explicit: true },
  { key: "handoff.ref", topicPattern: "handoff.ref.", runtimeId: "chat", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "artifact"], explicit: true },
  ...
  { key: "chat.user_message_recorded", topicPattern: "message.user.recorded", eventType: "custom_event", eventName: "message_user_recorded", runtimeId: "chat", scope: "active_run", visibility: "visible", targets: ["message"], explicit: true },
  { key: "chat.message_revised", topicPattern: "message.revised", eventType: "custom_event", eventName: "message_revised", runtimeId: "chat", scope: "session", visibility: "hidden", targets: ["history"], explicit: true },
  { key: "chat.branch_created", topicPattern: "session.branch.created", eventType: "custom_event", eventName: "session_branch_created", runtimeId: "chat", scope: "session", visibility: "hidden", targets: ["history"], explicit: true },
  ...
  { key: "chat.session_coordination_queued", topicPattern: "session_coordination.queued", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_promoted", topicPattern: "session_coordination.promoted", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_injected", topicPattern: "session_coordination.injected", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_replied", topicPattern: "session_coordination.replied", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_blocked", topicPattern: "session_coordination.blocked", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_failed", topicPattern: "session_coordination.failed", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_cancelled", topicPattern: "session_coordination.cancelled", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  { key: "chat.session_coordination_expired", topicPattern: "session_coordination.expired", eventType: "custom_event", eventName: "session_coordination", runtimeId: "chat", scope: "session", visibility: "visible", targets: ["message", "runtime_card", "history"], explicit: true },
  ...
  { key: "subagent.child_delegation", topicPattern: "delegation.child.", runtimeId: "subagent_swarm", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "hud", "artifact"], explicit: true },
