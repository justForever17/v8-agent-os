...
import { AutomationDeliveryReview } from "@admin/components/automation/AutomationDeliveryReview";
const HooksPage = dynamic(() => import("./hooks/page"));
const ScheduledTasksPage = dynamic(() => import("./cron/page"));
const WakeIngressPolicyCard = dynamic(() => import("@admin/components/automation/WakeIngressPolicyCard").then(module => module.WakeIngressPolicyCard));
