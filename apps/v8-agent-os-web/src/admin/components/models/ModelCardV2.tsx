...
import type { ControlPlaneModel, ModelDefaultCategory } from "@admin/components/models/control-plane-types";
...
import { ik, ir } from "@admin/i18n/admin-legacy";
import type { TranslationKey } from "@admin/lib/locale";
