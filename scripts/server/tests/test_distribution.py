...
class BundleTests(unittest.TestCase):
    def setUp(self):
        ...
        self.files = {
            ...
            "scripts/server/build-feature-packs.mjs": "import fs from 'node:fs'; if (!fs.existsSync('apps/v8-agent-os-cli/src/product_origin.mjs')) throw new Error('missing CLI product-origin compiler dependency'); fs.writeFileSync(process.argv[2], '// fixture compiled from tracked inputs\\n');\n",
            "apps/v8-agent-os-web/src/admin/lib/server/tracked.ts": "export const tracked = true;\n",
            "apps/v8-agent-os-cli/src/product_origin.mjs": "export const resolveProductOrigin = () => 'http://127.0.0.1:9527';\n",
