...
- fallback soft: trigger=`soft_token_budget`, applied=`True`, method=`rule_summary`
- fallback hard: trigger=`hard_token_budget`, applied=`True`, method=`llm_summary`
