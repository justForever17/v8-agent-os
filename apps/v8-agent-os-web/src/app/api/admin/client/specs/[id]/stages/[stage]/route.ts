...
export async function GET(
    ...
    try {
        ...
        const response = await engineFetch(`${ENGINE_URL}/specs/${encodeURIComponent(id)}/stages/${encodeURIComponent(stage)}${suffix}`, {
            method: "GET",
        ...
        console.error("[Client Specs] Read stage failed:", error);
