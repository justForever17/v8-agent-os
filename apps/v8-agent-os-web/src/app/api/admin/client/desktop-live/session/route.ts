...
import { fetchClientAdmin, forbidIfClientAdmin, requireClientContext } from "@admin/lib/server/client-proxy";
...
export async function POST(req: NextRequest) {
    ...
    try {
        const response = await fetchClientAdmin(req, "/desktop-live/session", { method: "POST" });
