...
export const RUNTIME_EVENT_TAXONOMY: RuntimeEventTaxonomyEntry[] = [
  ...
  { key: "capability.need", topicPattern: "capability.need.", runtimeId: "planner_lane", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "hud"], explicit: true },
  { key: "runtime.episode", topicPattern: "runtime.episode.", runtimeId: "planner_lane", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "hud"], explicit: true },
  { key: "handoff.ref", topicPattern: "handoff.ref.", runtimeId: "planner_lane", scope: "active_run", visibility: "visible", targets: ["runtime_card", "runtime_timeline", "artifact"], explicit: true },
