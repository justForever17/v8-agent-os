...
function buildPresetPolicy(runtime: RuntimeDescriptor, preset: RuntimePresetId): Required<RuntimePolicy> {
  ...
  if (preset === "debug") {
    return {
      ...
      notes: INTERNAL_READABLE.k1797d539df
    };
  }
  if (preset === "conservative") {
    return {
      ...
      notes: INTERNAL_READABLE.k481a959b15
    };
  }
  return {
    enabled: true,
    ...
    notes: INTERNAL_READABLE.k0a2d4271e2
  };
}
function riskLabel(value?: string) {
  if (value === "high") return INTERNAL_READABLE.k7a83b6c0e3;
  if (value === "medium") return INTERNAL_READABLE.k83a55f1235;
  if (value === "low") return INTERNAL_READABLE.k117a434875;
  return INTERNAL_READABLE.k86f9195e25;
}
