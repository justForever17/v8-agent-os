...
def render_memory_extraction_prompt(format_instructions: str) -> str:
    return (
        ...
        "12. Local paths are durable only when they describe a scoped project/channel workspace, deployment, or download convention. One-off generated file paths should be `daily_log`, and global path-like facts should not be durable.\n"
