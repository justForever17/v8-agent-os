...
- public: `0/10`
- internal: `0/10`
- details: `{"keys": ["favorite_shoe_brand", "shoe_brand_preference"], "note": "当前系统不会自动把语义相近的不同 key 归并成同一偏好。"}`
...
- public: `2/10`
- internal: `0/10`
- details: `{"preference_importance_threshold": {"current": 18, "default": 65}, "preference_confidence_threshold": {"current": 0.18, "default": 0.7}, "knowledge_importance_threshold": {"current": 20, "default": 55}, "knowledge_confidence_threshold": {"current": 0.2, "default": 0.65}, "global_knowledge_importance_threshold": {"current": 20, "default": 62}, "global_knowledge_confidence_threshold": {"current": 0`
