"use client";
import { createModelDraft } from "@admin/lib/model-hub/editor-drafts";
import { readJsonErrorMessage } from "@admin/lib/model-hub/errors";
import { type FormEvent, useState, useMemo, useRef, useEffect } from "react";
import { type AIModel, type AIProvider } from "@admin/lib/model-hub/types";
...
import { type ModelWireProtocol, MODEL_WIRE_PROTOCOLS } from "@admin/lib/model-hub/channels";
import { Input } from "@admin/components/ui/input";
import {
    resolveMediaCapabilityModes,
    getMediaCapabilityOptions,
    deriveMediaOperationKinds,
} from "@admin/lib/models/media-capabilities";
import { resolveAdminLabel } from "@admin/lib/admin-labels";
import { OutputTokenBudgetField } from "@admin/components/models/OutputTokenBudgetField";
import { RETRIEVAL_MODEL_TYPES, MEDIA_MODEL_TYPES } from "@admin/lib/model-hub/models";
