...
function CNFlag() {
    return (
        <svg id="flag-icons-cn" viewBox="0 0 640 480" className="h-3.5 w-5 flex-shrink-0 overflow-hidden rounded-sm border border-slate-200/10 shadow-sm">
            <defs>
...
function USFlag() {
    return (
        <svg id="flag-icons-us" viewBox="0 0 640 480" className="h-3.5 w-5 flex-shrink-0 overflow-hidden rounded-sm border border-slate-200/10 shadow-sm">
...
const OPTIONS: Array<{
    ...
    label: "layout.locale.label.zhCN" | "layout.locale.label.en";
