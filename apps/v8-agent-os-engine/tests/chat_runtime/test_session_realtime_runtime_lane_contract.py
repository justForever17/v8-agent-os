...
def test_subagent_and_engineering_lanes_do_not_enter_message_lifecycle():
    ...
    assert 'planner_lane' not in lifecycle_source


def test_runtime_taxonomy_keeps_swarm_and_engineering_on_separate_lanes():
    ...
    assert 'planner_lane' not in taxonomy_source
    assert '"planner_lane"' not in contract_source
