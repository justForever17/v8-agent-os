    ...
    return [
        ...
        },
        {
            ...
            "taskBrief": {
                ...
                "criticalFiles": ["apps/v8-agent-os-web/src/app/admin/(dashboard)/model-hub/page.tsx"],
                "readSet": ["apps/v8-agent-os-web/src/app/admin/(dashboard)/model-hub/page.tsx"],
                "writeSet": ["apps/v8-agent-os-web/src/app/admin/(dashboard)/model-hub/page.tsx"],
        ...
        },
        {
            ...
            "taskBrief": {
                ...
                "criticalFiles": ["apps/v8-agent-os-web/src/admin/lib/models/model-assets.ts"],
                "readSet": ["apps/v8-agent-os-web/src/admin/lib/models/model-assets.ts"],
                "writeSet": ["apps/v8-agent-os-web/src/admin/lib/models/model-assets.ts"],
