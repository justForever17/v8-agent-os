...
_PREFERENCE_KEY_ALIASES: dict[str, str] = {
    ...
    "emoji_usage": "response_language_style",
    "emoji_preference": "response_language_style",
    "emoticon_preference": "response_language_style",
    "kaomoji_preference": "response_language_style",
