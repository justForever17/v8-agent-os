...
export const RUNTIME_EVENT_TAXONOMY: RuntimeEventTaxonomyEntry[] = [
  { key: "chat.agent_start", topicPattern: "agent.started", eventType: "agent_start", runtimeId: "chat", scope: "active_run", visibility: "visible", targets: ["message", "runtime_card"], explicit: true },
  ...
  { key: "chat.ask_user", topicPattern: "approval.requested", eventType: "custom_event", eventName: "ask_user", runtimeId: "automation", scope: "active_run", visibility: "visible", targets: ["approval", "hud", "message"], explicit: true },
  { key: "chat.approval_resolved.approved", topicPattern: "approval.approved", eventType: "custom_event", eventName: "approval_resolved", runtimeId: "automation", scope: "active_run", visibility: "hidden", targets: ["approval", "hud", "runtime_card", "message"], explicit: true },
  { key: "chat.approval_resolved.rejected", topicPattern: "approval.rejected", eventType: "custom_event", eventName: "approval_resolved", runtimeId: "automation", scope: "active_run", visibility: "hidden", targets: ["approval", "hud", "runtime_card", "message"], explicit: true },
  { key: "chat.approval_resolved.auto", topicPattern: "approval.auto_approved", eventType: "custom_event", eventName: "approval_resolved", runtimeId: "automation", scope: "active_run", visibility: "hidden", targets: ["approval", "hud", "runtime_card", "message"], explicit: true },
  ...
  { key: "chat.run_state_changed", topicPattern: "run.state.changed", eventType: "custom_event", eventName: "run_controlled", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_card", "hud", "message"], explicit: true },
  { key: "chat.run_paused", topicPattern: "run.paused", eventType: "custom_event", eventName: "run_controlled", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_card", "hud", "message"], explicit: true },
  { key: "chat.run_resumed", topicPattern: "run.resumed", eventType: "custom_event", eventName: "run_controlled", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_card", "hud", "message"], explicit: true },
  { key: "chat.run_interrupted", topicPattern: "run.interrupted", eventType: "custom_event", eventName: "run_controlled", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_card", "hud", "message"], explicit: true },
  { key: "chat.run_cancelled", topicPattern: "run.cancelled", eventType: "custom_event", eventName: "run_controlled", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_card", "hud", "message"], explicit: true },
  { key: "chat.run_retry_requested", topicPattern: "run.retry.requested", eventType: "custom_event", eventName: "run_controlled", runtimeId: "chat", scope: "active_run", visibility: "hidden", targets: ["runtime_card", "hud", "message"], explicit: true },
  ...
  { key: "chat.safety_preflight_blocked", topicPattern: "safety.preflight.blocked", eventType: "custom_event", eventName: "safety_blocked", runtimeId: "chat", scope: "active_run", visibility: "visible", targets: ["runtime_card", "hud", "message"], explicit: true },
