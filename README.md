...
- Desktop Preview: Windows x64/ARM64 installers, macOS 13.0+ Intel/Apple Silicon DMGs, and Linux x64/arm64 AppImage or DEB packages. Check each published release for available downloads and checksums.
