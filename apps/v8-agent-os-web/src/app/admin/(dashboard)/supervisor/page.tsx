...
export default function SupervisorPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetchAdminJson<Record<string, unknown>>("/api/admin/supervisor"),
      fetchAdminJson<AIModel[]>("/api/admin/models"),
      fetchAdminJson<{ mcpTools?: MCPTool[] }>("/api/admin/mcp/tools"),
      fetchAdminJson<{ value?: string | null; source?: string | null }>("/api/admin/settings/vision-model"),
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (savedData && typeof savedData === "object") {
        primeAdminJsonCache("/api/admin/supervisor", savedData);
      ...
      const visionRes = await fetch("/api/admin/settings/vision-model", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
      ...
      if (visionData && typeof visionData === "object") {
        primeAdminJsonCache("/api/admin/settings/vision-model", visionData);
      }
      toast({
