...
INITIAL_STREAM_IDLE_TIMEOUT_SECONDS = float(os.getenv("V8_GRAPH_STREAM_INITIAL_IDLE_TIMEOUT_SECONDS", "240"))
ACTIVE_MODEL_STREAM_IDLE_TIMEOUT_SECONDS = float(os.getenv("V8_GRAPH_STREAM_MODEL_IDLE_TIMEOUT_SECONDS", "90"))
