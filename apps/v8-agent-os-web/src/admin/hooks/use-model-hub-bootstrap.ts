...
import { mergeAudioConfig, type AudioRuntimeConfig } from "@admin/lib/model-hub/audio";
import type { CatalogProvider } from "@admin/lib/model-hub/catalog";
import { preserveModelOrder } from "@admin/lib/model-hub/models";
import type { AIModel, ModelHubBootstrapPayload } from "@admin/lib/model-hub/types";

const BOOTSTRAP_URL = "/api/admin/model-hub/bootstrap";
