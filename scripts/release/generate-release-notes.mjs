...
function assetSection(product, version, channel) {
  if (product === "all") {
    ...
    return [
      ...
      "- `V8-Agent-OS-" + desktopVersion + "-macos-x64.dmg` 与 `V8-Agent-OS-" + desktopVersion + "-macos-arm64.dmg`：macOS 13.0 及以上 Intel/Apple Silicon " + desktopLabel + "。",
  ...
  const assets = [
    ...
    "- `V8-Agent-OS-" + desktopVersion + "-macos-x64.dmg`：macOS 13.0 及以上 Intel " + desktopLabel + "。",
    "- `V8-Agent-OS-" + desktopVersion + "-macos-arm64.dmg`：macOS 13.0 及以上 Apple Silicon " + desktopLabel + "。",
