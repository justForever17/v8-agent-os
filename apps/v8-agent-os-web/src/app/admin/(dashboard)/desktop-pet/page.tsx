...
import type { ShellDesktopPetState } from "@admin/components/layout/ShellWindowControls";
...
const API_PATH = "/api/admin/config-registry/desktop-pet";
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <ConfigCard title={t("app.admin.dashboard.desktopPet.appearance")} description={t("app.admin.dashboard.desktopPet.appearanceDescription")}>
          <div className="mb-6 max-w-xs space-y-2">
            <label className="text-sm" htmlFor="companion-skin">{t("app.admin.dashboard.desktopPet.skin")}</label>
            <Select value={data.appearance?.skinId || "core-eye"} onValueChange={skinId => updateAppearance({ skinId })}>
              <SelectTrigger id="companion-skin"><SelectValue /></SelectTrigger>
              <SelectContent>
                <SelectItem value="core-eye">{t("app.admin.dashboard.desktopPet.skinCoreEye")}</SelectItem>
                <SelectItem value="soft-orb">{t("app.admin.dashboard.desktopPet.skinSoftOrb")}</SelectItem>
              </SelectContent>
            </Select>
          </div>
