...
class AgentState(TypedDict):
    ...
    supervisor_runtime_mode: NotRequired[str]
    supervisorRuntimeMode: NotRequired[str]
    spec_mode: NotRequired[bool]
    specMode: NotRequired[bool]
    spec_id: NotRequired[str]
    specId: NotRequired[str]
    spec_brief: NotRequired[dict]
    specBrief: NotRequired[dict]
    spec_command: NotRequired[dict]
    specCommand: NotRequired[dict]
    specContinuation: NotRequired[dict]
    specRevision: NotRequired[dict]
    spec_next_stage: NotRequired[str]
    specNextStage: NotRequired[str]
    runtimeAllowed: NotRequired[bool]
    runtimeExecutionAllowed: NotRequired[bool]
    ...
    plugin_references: NotRequired[list]
    pluginReferences: NotRequired[list]
    plugin_authorizations: NotRequired[list]
    ...
    original_workspace_path: NotRequired[str]
    originalWorkspacePath: NotRequired[str]
    repository_root: NotRequired[str]
    repositoryRoot: NotRequired[str]
    worktree_root: NotRequired[str]
    worktreeRoot: NotRequired[str]
    worktree_id: NotRequired[str]
    worktreeId: NotRequired[str]
    sandbox_lease_id: NotRequired[str]
    sandboxLeaseId: NotRequired[str]
    sandbox_policy: NotRequired[dict]
    sandbox_policy_digest: NotRequired[str]
    sandbox_policy_file: NotRequired[str]
    sandbox_capabilities: NotRequired[dict]
    managed_engineering_execution: NotRequired[bool]
