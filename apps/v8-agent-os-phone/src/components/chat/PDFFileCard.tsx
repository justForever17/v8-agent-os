...
export const PDFFileCard = memo(function PDFFileCard({
    ...
    const handleDownload = async () => {
        try {
            ...
            Alert.alert(t("src.components.chat.downloadfilecard.download_failed"), error instanceof Error ? error.message : t("src.components.chat.pdffilecard.unable_to_save_pdf_file"));
        }
    };
