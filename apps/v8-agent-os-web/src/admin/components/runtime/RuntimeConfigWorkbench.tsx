...
import { getRuntimeDisplayName, getRuntimeDisplayText, isCanonicalRuntimeKind, isLockedRuntimeKind } from "@admin/lib/runtime-admin";
...
export function RuntimeConfigWorkbench({
    ...
    const handleToggle = useCallback(async (checked: boolean) => {
        ...
        setSaving(true);
        try {
            const response = await fetch(`/api/admin/runtime-capabilities/${encodeURIComponent(kind)}/policy`, {
                method: "POST",
